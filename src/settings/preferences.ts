...
const translations: Record<string, Record<TranslationKey, string>> = {
  "zh-CN": {
    ...
    "guide.message3": "每完成一轮迭代，都要把时间、用户输入、AI 最终输出、改动文件和验证结果追加到 docs/codex-iteration-log.md。",
  ...
  "zh-TW": {
    ...
    "guide.message3": "每完成一輪迭代，都要把時間、使用者輸入、AI 最終輸出、改動檔案和驗證結果追加到 docs/codex-iteration-log.md。",
  ...
  "en-US": {
    ...
    "guide.message3": "After each iteration, append the time, user input, AI final output, changed files, and verification result to docs/codex-iteration-log.md.",
